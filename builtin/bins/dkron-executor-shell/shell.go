...
func (s *Shell) Execute(args *plugin.ExecuteRequest) (*plugin.ExecuteResponse, error) {
	out, err := s.ExecuteImpl(args)
	resp := &plugin.ExecuteResponse{Output: out}
	if err != nil {
...
func (s *Shell) ExecuteImpl(args *plugin.ExecuteRequest) ([]byte, error) {
